...
DZE_DEPLOYABLES_CONFIG = [
    ...
    ["ItemToolbox",[0,6,1],5,0.1,false,false,false,false,false,true,true,["CSJ_GyroC"],[],["PartGeneric"],"true"]
];

if (GTS_VirtualGarage) then {
	DZE_DEPLOYABLES_CONFIG = DZE_DEPLOYABLES_CONFIG + [["ItemToolbox",[0,9,2],5,0.9,true,true,false,true,true,false,true,["HeliHCivil"],[],[],"true"]];
};
...
DZE_DEPLOYABLE_ADMINS = GTS_Admins;
